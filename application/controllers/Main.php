...
class Main extends CI_Controller {
	...
	public function single_auction($type,$id){
		$data = self::$data;
		$data['listing_data']					=	$this->database->_get_row_data('tbl_listings',array('id'=>$id,'listing_type'=>$type,'listing_option'=>'auction','status'=>1),'',true);
	...
	public function single_offers($type,$id){
		$data = self::$data;
		$data['listing_data']								=	$this->database->_get_row_data('tbl_listings',array('id'=>$id,'listing_type'=>$type,'listing_option'=>'classified','status'=>1),'',true);
