    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-content-inner" >
         ...
         <div class="dashboard-headline">
          ...
          <nav id="breadcrumbs" class="dark">
           <ul>
            <li><a href="#">Home</a></li>
            <li><a href="#">Manage Platforms</a></li>
          </ul>
        </nav>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xl-12">
         ...
         <div class="card">
           <div class="card-body">
            <form id="PlatformsSettingsForm" method="post" enctype="multipart/form-data"/>

            <div class="col-xl-12">
             <div class="submit-field">
              <label for="category_name">PLATFORM (Ex: Facebook)</label>
        ...
        <div class="col-xl-12">
         <div class="submit-field">
          <label for="category_meta_description">PLATFROM DOMAIN <small>(Ex: facebook.com) </small></label>
          <input type="text" class="with-border" id="platfrom_domain" name = "platfrom_domain" placeholder="Platform Domain Name" required="true">
        </div>
      </div>
      ...
      <div class="col-xl-12">
       <div class="submit-field">
        <label for="listing_type">PLATFORM TYPE</label>
        <select class="form-control" id="listing_type" name="listing_type">
          <?php foreach ($platforms as $platform) { if(!in_array($platform['platform'],array('domain','website','app'))) { ?> ?>
            ...
            <table class="table table-bordered tbl_responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $platform['platfrom']; ?></td>
                  <td><?= strtoupper($platform['listing_type']); ?></td>
                  <td>
                    <button data-id="<?= $platform['id']; ?>" type="button" class="btn btn-success editplatforms"><i class="fas fa-edit"></i></button>
                    <button data-id="<?= $platform['id']; ?>" type="button" class="btn btn-danger deleteplatforms"><i class="far fa-trash-alt"></i></button>
                  </td>
                </tr>
                <?php } ?>
