			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
                        ...
                        <div class="col-xl-12">
							             <div class="submit-field">
                         		<label for="category_url_slug">URL SLUG | <small><strong>(Category URL slugs were auto generated according to titles, But if you do not like you may enter valid unique slugs of your own)</strong></small></label>
                          		<input type="text" class="with-border" id="category_url_slug" name = "category_url_slug" placeholder="URL Slug" required="true">
                          	</div>
                        </div>
