					...
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="User Controls">
							...
							<?php if(file_exists(APPPATH.'/libraries/Referral_Module.php')) { ?>
								<li><a href="<?php echo site_url('refferal/admin_referral'); ?>"><i class="icon-material-outline-star"></i> Refferal Controls <span class="badge badge-warning">new</span></a></li>
							<?php } ?>
