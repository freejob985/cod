...
<!--User Page Meta Tags-->
<title>Create Domains |<?php echo $this->lang->line('site_name') ?> | Admin Dashboard</title>
<meta charset="utf-8">
	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				<h3><b>Create a Domain Listing </b></h3>
						...
						<div class="panel panel-default">
							...
							<!-- Headline -->
								<div class="headline">
									...
									<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i> Create Domains Form</a></h3>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-xl-8">
									<div class="submit-field">
										...
										<input type="hidden" name="listing_type" name="listing_type" value="domain">
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-xl-6">
									<div class="submit-field">
										<h5>Tagline</h5>
										<input type="text" id="website_tagline" name="website_tagline" class="required form-control" placeholder="Tag Line" value="" required>
									</div>
								</div>
								...
								<div class="col-xl-6">
									<div class="submit-field">
										...
										<textarea id="website_metadescription" name="website_metadescription" rows = "5" cols = "60" class="required form-control"></textarea>
									</div>
								</div>
								...
								<div class="col-xl-12">
									<div class="submit-field">
										...
										<textarea id="summernote" name="editordata" rows = "5" cols = "60" class="form-control"></textarea>
									</div>
								</div>
