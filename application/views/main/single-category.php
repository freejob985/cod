				...
				<form>
					<div class="row">
						<div class="col-md-8 col-sm-8">
							<input id="searchterm" name="searchterm" type="text" class="form-control" placeholder="<?= $this->lang->line('lang_search_place_holder'); ?>">
						</div>
			...
			<div id="sidebar-search" class="sidebar-container collapse show">
				...
				<div class="sidebar-widget">
					...
					<select id="marketplace-input" name="marketplace-input" class="form-control default">
						...
						<option value="<?= $key ?>"><?= ucfirst($this->lang->line($key)); ?></option>
						<?php } ?>
					</select>
				</div>
