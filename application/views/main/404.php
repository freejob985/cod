          ...
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              ...
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4 text-white">
                <h2 class="text-white"><?= $this->lang->line('lang_404_sorry') ?></h2>
                <h3 class="font-weight-light text-white"><?= $this->lang->line('lang_404_sorry_sub') ?></h3>
              </div>
            </div>
            <div class="row mt-5">
              <div class="col-12 text-center mt-xl-2">
                <a class="text-white font-weight-medium" href="<?php echo base_url();?>"><b><?= $this->lang->line('lang_404_back') ?></b></a>
              </div>
            </div>
            <div class="row mt-5">
