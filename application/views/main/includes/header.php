        ...
        <div class="row align-items-center">
            <div class="col-md-9">
                <ul class="text-center text-md-left top-social">
                    <li><span><a href="https://resources.startupdeals.net/" class="f-size-14 text-white"><img src="<?php echo base_url() ?>assets/img/top-1.png" alt="" draggable="false"> <?php echo $this->lang->line('lang_header_top_support'); ?></a></span></li>
                    <li>
            ...
            <div class="col-md-3 text-center text-md-right">
                <div class="slippa-nav-tolls">
                	<?php if(!isset($userdata[0]['username'] )) { ?>
                    	<span class="d-md-inline margin-right-15 text-333 open-cart-opt"><a href="<?php echo base_url() ?>login"><i class="fas fa-sign-in-alt" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('lang_header_main_login'); ?>"></i></a></span>
                    	<span class="d-md-inline margin-right-15 text-333 open-cart-opt"><a href="<?php echo base_url() ?>signup"> <i class="fas fa-user-plus" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('lang_header_main_signup'); ?>"></i></a></span>
                    <?php } else { ?>
                    	<?php if($userdata[0]['user_level'] !== '0' ) { ?>
                    		<span class="d-md-inline margin-right-15 text-333"><a href="<?php echo base_url() ?>user"> <b><?php echo $this->lang->line('lang_header_top_welcome'); ?> </b><?php echo $userdata[0]['username']; ?></a> !</span>
                    		<span class="d-md-inline margin-right-15 text-333 open-cart-opt"><a href="<?php echo base_url() ?>user/logout"><i class="fas fa-sign-out-alt" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('lang_header_main_logout'); ?>"></i></a></span>
                    	<?php } else { ?>
                    		<span class="d-md-inline margin-right-15 text-333"><b><?php echo $this->lang->line('lang_header_top_welcome'); ?> </b><a href="<?php echo base_url() ?>admin"> <?php echo $userdata[0]['username']; ?></a> !</span>
                    		<span class="d-md-inline margin-right-15 text-333 open-cart-opt"><a href="<?php echo base_url() ?>admin/logout"><i class="fas fa-sign-out-alt" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('lang_header_main_logout'); ?>"></i></a></span>
                    	<?php }?>
                    <?php } ?>
