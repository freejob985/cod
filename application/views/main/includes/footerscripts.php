  ...
  <script src="<?php echo base_url(); ?>assets/js/common.js?v=3.1"></script>
  <script src="<?php echo base_url(); ?>assets/js/custom.js?v=3.4"></script>
  <script src="<?php echo base_url(); ?>assets/js/cart.js"></script>
  <script src="<?php echo base_url(); ?>assets/js/chart.js?v=3.1"></script>
  <script src="<?php echo base_url(); ?>assets/js/chat.js"></script>
  <script src="<?php echo base_url(); ?>assets/js/tables.js?v=2.4"></script>
 	<!-----------------------------------------Data Passing Jquery------------------------------------------------------------------>
