...
<title><<?php echo $this->lang->line('lang_btn_search').' '.strtoupper($this->lang->line($searchtype)) ?> | <?php echo $this->lang->line('site_name'); ?> </title>
<meta name="og:title" content="<?php echo $this->lang->line('lang_btn_search').strtoupper($this->lang->line($searchtype)) ?> | Domain Marketplace"/>
...
<meta name="og:site_name" content="<?php echo $this->lang->line('lang_btn_search').' '.strtoupper($this->lang->line($searchtype)) ?> | <?php echo $this->lang->line('site_name'); ?> "/>
    ...
    <div class="container">
        <div class="row slippa-breadcump-height align-items-center">
            <div class="col-lg-12 mx-auto text-center text-white">
                <h4 class="f-size-70 f-size-lg-50 f-size-md-40 f-size-xs-24 slippa-strong"><?php echo $this->lang->line('lang_btn_search').' '.strtoupper($this->lang->line($searchtype)) ?></h4>        
            </div><!-- /.col-12 -->
        </div><!-- /.row -->
    </div><!-- /.container -->
</div><!-- /.slippa-bredcump -->
				...
				<form>
					<div class="row">
						<div class="col-md-8 col-sm-8">
							<input id="searchterm" name="searchterm" value="<?php if(!empty($searchterm)) echo $searchterm; ?>" type="text" class="form-control border" placeholder="<?= $this->lang->line('lang_search_place_holder'); ?>">
						</div>
				...
				<div class="sidebar-widget">
					...
					<div class="keywords-container">
						<div class="keyword-input-container">
							<input type="text" class="keyword-input" placeholder="<?= $this->lang->line('lang_tags_place_holder'); ?>"/>
