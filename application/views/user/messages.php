...
<!--User Page Meta Tags-->
<title><?= $this->lang->line('lang_message_title') ?> | <?php echo $this->lang->line('site_name') ?>| <?= $this->lang->line('lang_userdashbaord_title') ?></title>
<meta charset="utf-8">
	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				<h3><?= $this->lang->line('lang_message_title') ?></h3>

				<!-- Breadcrumbs -->
				<nav id="breadcrumbs" class="dark">
					<ul>
						<li><a href="<?= base_url() ?>user"><?= $this->lang->line('lang_user_home') ?></a></li>
						<li><?= $this->lang->line('lang_message_title') ?></li>
					</ul>
				</nav>
			</div>
					...
					<div class="messages-container-inner">
						...
						<div class="message-content">
							...
							<div class="messages-headline">
								...
								<h4 id="ChatName"><?= $this->lang->line('lang_message__click') ?></h4>
							</div>
							...
							<div class="message-reply">
								<textarea id="chat_message" class="chat-textarea" cols="1" rows="1" placeholder="<?= $this->lang->line('lang_message_txt_place') ?>" data-autoresize></textarea>
