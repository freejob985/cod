...
define('SP_WEBPATH', 'https://startupdeals.net/seo');

# DB settings - You can get this info from your web hosting provider.
# The name of the database for seo panel
define('DB_NAME', 'livecuob_seo746');

# DB database username
define('DB_USER', 'livecuob_seo746');

# DB database password
define('DB_PASSWORD', 'D09X@S(-[8wSbp');
